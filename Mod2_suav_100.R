...
#-Defining data-
data_dinam_suav_100 <- list("n"=n,"m"=m,"y"=c(datos$WTI[1:(n-3)],rep(NA,m)), "x"=select(datos, -WTI))
...
set.seed(semilla)
mod_dinam_suav_100.sim<-jags(data_dinam_suav_100,inits,parameters,model.file="suavizamiento2_lambda_100.txt",
...
out_dinam_suav_100.sum.t_beta<-cbind(out_dinam_suav_100.sum[grep("beta",rownames(out_dinam_suav_100.sum)),c(1,3,5,7)],modas_dinam_suav_100_beta)
